...
with mp_holistic.Holistic(min_detection_confidence=0.7, min_tracking_confidence=0.7) as holistic:
    header = ["x", "y", "z"]
    file_loc = "A:/Project-Sign-Language/ML-Raw-videos/Out_source/"+str(file_num)+"/data/left_hand_landmarks/3.csv"
    with open(file_loc, 'w', newline='') as file:
        ...
        while cap.isOpened():
         ...
         if hasattr(results.left_hand_landmarks, "landmark") == True:     
